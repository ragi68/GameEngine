...
namespace Proto {
	...
	Camera3D::Camera3D(float fov, float aspect_ratio, float n, float f) : p_Matrix(glm::perspective(fov, aspect_ratio, n, f))
	{
	...
	void Camera3D::SetProjectionMatrix(float fov, float aspect_ratio, float n, float f)
	{
	...
	Camera2D::Camera2D(float fov, float aspect_ratio, float n, float f)
	{
	}
	...
	void Camera2D::SetRotation(glm::vec3 rotation)
	{
	}

	void Camera2D::SetProjectionMatrix(float fov, float aspect_ratio, float n, float f)
	{
	}

	void Camera2D::ReCalculateVPMatrix()
	{
	}
}